...
2. If it returns projects → confirm "✅ Connected to Heroboard" and list them. Mention that human-presence effort heartbeats (on prompts, plus a ~60s presence ticker) are active and cost no tokens.
